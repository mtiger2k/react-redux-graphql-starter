...
class Dialog extends React.Component {
   ...
   * @param options.size {[null, 'medium', 'large', 'small']} The width size for dialog.
   ...
   * @param size {[null, 'medium', 'large', 'small']} The width size for dialog.
   */
  ...
  render () {
    return (
      <Modal isOpen={this.state.showModal} toggle={this.toggle} onExit={this.onHide} size={this.state.size}>
        {
          this.state.title && (
            <ModalHeader>
              {this.state.title}
